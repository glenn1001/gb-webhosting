...
class DirectAdmin_HTTPSocket {
    ...
    private $remote_host;
    private $remote_port;
    private $remote_uname;
    private $remote_passwd;
    
    private $result;
    private $result_header;
    private $result_body;
    private $result_status_code;
    
    private $lastTransferSpeed;
    ...
    private $doFollowLocationHeader = TRUE;
    private $redirectURL;
     ...
     */
    private function fetch_header($header = '') {
